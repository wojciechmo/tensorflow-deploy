...
if __name__ == "__main__":
	...
	# for Java deployment
	tf.saved_model.simple_save(sess, './model_java', inputs={"x": x}, outputs={"y": y})

	# for C++ deployment, it can also be used for Java but in such scenario one should use JavaCpp package to load model
